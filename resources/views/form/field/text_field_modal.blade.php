<div class="modal fade" id="text_store_or_update_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-1">
            ...
            <div class="modal-body">
                <form id="text_store_or_update_form" class="form" method="POST">
                    @csrf
                    <input type="hidden" id="form_id" name="form_id" value="{{ $form->id }}">
                    <input type="hidden" id="update_id" name="update_id">
                    <input type="hidden" id="form_name" name="form_name" value="text">
                    <x-input labelName="Title" required="required" name="label"/>
                    <x-input labelName="Placeholder" name="placeholder"/>
                    <x-select labelName="Type" name="type" required="required">
                ...
                <div class="text-right">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="save-btn" data-form="text"><span></span> Save</button>
                </div>
            </div>
        </div>
    </div>
